...
const Trial = () => {
    return (
        <div className='w-full lg:h-96 h-auto lg:my-0 my-24 flex justify-center items-center lg:gap-48 gap-10 text-yellow-900 font-bold text-3xl'>
            ...
            <div className="drop-shadow-xl dark:text-yellow-600">TRẢI NGHIỆM NGAY</div>
            <div className="text-orange-200 bg-yellow-900 dark:bg-yellow-600 dark:hover:bg-orange-200 rounded-lg p-4 hover:bg-orange-200 hover:text-yellow-600 drop-shadow-xl">
                <Link to="/purchase">
