    ...
    return (
        <div className=' h-full pb-2 drop-shadow-xl'>
            <div className="h-20 text-xl font-bold  p-3 flex items-center justify-around drop-shadow-xl">
                <div className="text-orange-200 dark:text-yellow-600">
                    BLACK ENERGY
                </div>
            ...
            <div className="text-orange-200 bg-slate ">
                {
                    nav.map((item, index) => (
                        <div className="hover:bg-orange-200 dark:hover:bg-orange-200 hover:text-yellow-900 dark:hover:text-grey-600 bg-yellow-900 dark:bg-grey-600 p-3" key={index}>
